...
const UserBox = ({ user }: Props) => {
    ...
    return (
        <div onClick={() => setSelectedUser(user)} className={`flex gap-5 p-4 items-center cursor-pointer hover:bg-[var(--user-hover-bg)] ${id === selectedUser?.id && "bg-[var(--user-bg)] hover:bg-[#1b68b3]"} `}>
