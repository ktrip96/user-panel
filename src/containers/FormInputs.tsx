        ...
        <>
            <div className='flex flex-col mb-2'>
                ...
                <input
                    ...
                    value={userData.name}
                    className={`rounded w-full py-2 px-3 leading-tight text-lg lg:text-xl focus:outline-blue-500 focus:shadow ${isEmpty(userData.name) && "border border-red-400 focus:outline-red-400"} `} />
            ...
            <div className='flex flex-col mb-2'>
                ...
                <input
                    ...
                    className={`rounded w-full py-2 px-3 leading-tight text-lg lg:text-xl focus:outline-blue-500 focus:shadow ${!isValidEmail(userData.email) && "border border-red-400 focus:outline-red-400"} `} />
            ...
            <div className='flex flex-col mb-2'>
                ...
                <input
                    ...
                    className={`rounded w-full py-2 px-3 leading-tight text-lg lg:text-xl focus:outline-blue-500 focus:shadow ${isEmpty(userData.phone) && "border border-red-400 focus:outline-red-400"} `} />
