    ...
    return (
        <div className={`w-full md:w-1/2 p-5 pb-20 relative`}>
            <form className='p-5 h-full overflow-y-auto '>
                ...
                {configureUserAttributeOrder(userAttributes).slice(2).map((item) => (
...
function configureUserAttributeOrder(attributes: string[]): string[] {
    attributes.push(attributes.splice(3, 1)[0])
    return attributes
}

function shallowEqual(object1: User, object2: User) {
